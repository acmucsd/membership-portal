module.exports = (User, Event) => Promise.all([
  ...
  Event.create({
    ...
    start: new Date(2019, 10, 29, 18),
    end: new Date(2019, 10, 29, 20),
  ...
  Event.create({
    ...
    start: new Date(2019, 11, 8, 19),
    end: new Date(2019, 11, 8, 21),
    attendanceCode: 'p0ng',
    pointValue: 10,
  }),
  ...
  Event.create({
    ...
    start: new Date(2019, 10, 15, 14),
    end: new Date(2019, 10, 15, 18),
    attendanceCode: 'n0d3',
    pointValue: 30,
  }),
]);

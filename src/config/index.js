...
module.exports = {
  ...
  file: {
    ...
    MAX_MAIN_BANNER_FILE_SIZE: process.env.MAX_MAIN_BANNER_FILE_SIZE,
    ...
    MAIN_BANNER_UPLOAD_PATH: process.env.BASE_UPLOAD_PATH + process.env.MAIN_BANNER_UPLOAD_PATH,
  },
